...
export default class ExecutiveKpiDashboard extends LightningElement {
    ...
    get overallScore() {
        if (!this.dashboardData || !this.dashboardData.frameworks || this.dashboardData.frameworks.length === 0) {
            return 0;
        }
    ...
    get totalGaps() {
        return this.dashboardData && this.dashboardData.recentGaps ? this.dashboardData.recentGaps.length : 0;
    }
